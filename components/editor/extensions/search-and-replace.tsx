...
declare module "@tiptap/core" {
  interface Commands<ReturnType> {
    search: {
      ...
      /**
       * @description Direct search and replace without relying on storage state
       */
      searchAndReplaceAll: (
        searchTerm: string,
        replaceTerm: string
    ...
    return {
      ...
      searchAndReplaceAll:
        ...
        ({ tr, dispatch, state }) => {
          ...
          // 2. Scan the document for matches
          ...
          // 3. Process Replacements (Backwards to avoid index shifting issues)
