...
const ImagePlaceholderToolbar = React.forwardRef<HTMLButtonElement, React.ComponentPropsWithoutRef<typeof Button>>(
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button
            ...
            {...props}
          >
            {children ?? <Image aria-label="Image" className="h-4 w-4" />}
          </Button>
        </TooltipTrigger>
        <TooltipContent>
          <span>Image</span>
