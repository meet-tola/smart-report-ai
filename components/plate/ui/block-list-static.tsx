...
const config: Record<
  string,
  {
    Li: React.FC<RenderElementProps>;
    Marker: React.FC<RenderElementProps>;
  }
> = {
  todo: {
    Li: TodoLiStatic,
...
function List(props: RenderElementProps) {
...
function TodoMarkerStatic(props: RenderElementProps) {
...
function TodoLiStatic(props: RenderElementProps) {
  return (
    <li
      className={cn(
        "list-none",
