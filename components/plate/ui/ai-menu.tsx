...
Start writing a new paragraph AFTER <Document> ONLY ONE SENTENCE`
  ...
  emojify: {
    ...
    value: "emojify",
    onSelect: ({ editor }) => {
      void editor.getApi(AIChatPlugin).aiChat.submit("Emojify");
    },
  },
  explain: {
    icon: <BadgeHelp />,
  ...
  fixSpelling: {
    ...
    value: "fixSpelling",
    onSelect: ({ editor }) => {
      void editor.getApi(AIChatPlugin).aiChat.submit("Fix spelling and grammar");
    },
  },
  generateMarkdownSample: {
    ...
    onSelect: ({ editor }) => {
      void editor.getApi(AIChatPlugin).aiChat.submit("Generate a markdown sample");
    },
  },
  generateMdxSample: {
    icon: <BookOpenCheck />,
    ...
    onSelect: ({ editor }) => {
      void editor.getApi(AIChatPlugin).aiChat.submit("Generate a mdx sample");
    },
  },
  improveWriting: {
    icon: <Wand />,
    ...
    onSelect: ({ editor }) => {
      void editor.getApi(AIChatPlugin).aiChat.submit("Improve the writing");
    },
  },
  insertBelow: {
    icon: <ListEnd />,
  ...
  makeLonger: {
    ...
    value: "makeLonger",
    onSelect: ({ editor }) => {
      void editor.getApi(AIChatPlugin).aiChat.submit("Make longer");
    },
  },
  makeShorter: {
    icon: <ListMinus />,
    ...
    value: "makeShorter",
    onSelect: ({ editor }) => {
      void editor.getApi(AIChatPlugin).aiChat.submit("Make shorter");
    },
  },
  replace: {
    icon: <Check />,
  ...
  simplifyLanguage: {
    ...
    onSelect: ({ editor }) => {
      void editor.getApi(AIChatPlugin).aiChat.submit("Simplify the language");
    },
  },
  summarize: {
    icon: <Album />,
